...
%
% Description: Short Matlab script for benchmarking some key aspects of
% SVMs for the specific task of handwritten digit recognition and comparing
% these results to some numbers from a competing KNN classifier.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
